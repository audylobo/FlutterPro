...
import 'menu/lagos.dart';
import 'menu/provider/lake_provider.dart';
import 'menu/sensor.dart';
import 'models/mysuperlago.dart';
import 'pages/lakes/provider/date_provider.dart';
import 'pages/lakes/provider/detalle_pescado.dart';
