...
void oalneg() => runApp(OscarNegro());
var currentCar = pezList.fishs[0];

class OscarNegro extends StatelessWidget{
...
class OscarNegr extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Oscar_negro.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Oscar Negro", nombrePez: "acara ocellatu", pais:"Sudamerica", imglist: [

    'assets/images/Oscar_negro.png',
  ], detalle:[

    {Icon(Icons.favorite, size: icoSize, color: Colors.pink):"EDAD MAX: 3 Años"},
    {Icon(FontAwesomeIcons.weightHanging, size: icoSize, color: Colors.blue):"Peso Max: 14 gramos"},

  ],mediciones: [
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 30 cm"},
    {Icon(Icons.remove_circle_outline, size:icoSize, color: Colors.red):"Tamaño Minimo: 10 cm"},

  ],estiloDeVida: [
    {Icon(FontAwesomeIcons.temperatureHigh, size:icoSize, color:Colors.red):{"Temperatura maxima(upto)": "28 "}},
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"20"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.red):{"PH Maximo":"7.5"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.blue):{"PH Minimo":"6"}},

  ],descripcion: [
   {Icon(FontAwesomeIcons.indent, size: icoSize, color: Colors.pink):{"Descripcion": "Para que se adapte bien al acuario, necesitará un sustrato suave y abundancia de rocas grandes que formen cuevas. De esta manera se reproducen las características propias de su hábitat salvaje. Los machos son agresivos entre ellos y también con hembras despreciadas para su grupo. Se reproducen y desovan entre las rocas."}}
  ]
  ),
]);
