...
void oalbino() => runApp(OscarAlbino());
var currentCar = pezList.fishs[0];

class OscarAlbino extends StatelessWidget{
...
class OscarAl extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Oscar_albino.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Oscar Albino", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Oscar_albino.png',
  ], detalle:[
