...
void oalco() => runApp(OscarComun());
var currentCar = pezList.fishs[0];

class OscarComun extends StatelessWidget{
...
class OscarCo extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Oscar_comun.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Oscar comun", nombrePez: "Astronotus ocellatus", pais:"cali", imglist: [

    'assets/images/Oscar_comun.png',
  ], detalle:[
    ...
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 35 cm"},
