...
void oalrojo() => runApp(OscarRojo());
var currentCar = pezList.fishs[0];

class OscarRojo extends StatelessWidget{
...
class OscarRoo extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Oscar_rojo.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Oscar Rojo", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Oscar_rojo.png',
  ], detalle:[
