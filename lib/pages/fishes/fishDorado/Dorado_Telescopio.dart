...
void doradotele() => runApp(DoradoTelescopio());
var currentCar = pezList.fishs[0];

class DoradoTelescopio extends StatelessWidget{
...
class DoradoTeles extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_telescopio.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado Telescopio", nombrePez: "tele", pais:"cali", imglist: [

    'assets/images/Dorado_telescopio.png',
  ], detalle:[
    ...
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"10"}},
