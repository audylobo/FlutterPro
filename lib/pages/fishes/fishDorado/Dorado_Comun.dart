...
void doradocom() => runApp(DoradoComun());
var currentCar = pezList.fishs[0];

class DoradoComun extends StatelessWidget{
...
class DoradoComu extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_comun.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Comun", pais:"cali", imglist: [

    'assets/images/Dorado_comun.png',
  ], detalle:[
