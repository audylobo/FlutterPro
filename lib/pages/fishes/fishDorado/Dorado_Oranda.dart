...
void doradoora() => runApp(DoradoOranda());
var currentCar = pezList.fishs[0];

class DoradoOranda extends StatelessWidget{
...
class DoradoOran extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_oranda.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Oranda", pais:"cali", imglist: [

    'assets/images/Dorado_oranda.png',
  ], detalle:[
