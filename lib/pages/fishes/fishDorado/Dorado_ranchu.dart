...
void doradoran() => runApp(DoradoRanchu());
var currentCar = pezList.fishs[0];

class DoradoRanchu extends StatelessWidget{
...
class DoradoRan extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_ranchu.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado Ranchu", nombrePez: "Ranchu", pais:"cali", imglist: [

    'assets/images/Dorado_ranchu.png',
  ], detalle:[
