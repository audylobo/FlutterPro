...
void doradoper() => runApp(DoradoPerla());
var currentCar = pezList.fishs[0];

class DoradoPerla extends StatelessWidget{
...
class DoradoPerl extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_perla.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Perla", pais:"cali", imglist: [

    'assets/images/Dorado_perla.png',
  ], detalle:[
