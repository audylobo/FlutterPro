...
void doradofenix() => runApp(DoradoPhoenix());
var currentCar = pezList.fishs[0];

class DoradoPhoenix extends StatelessWidget{
...
class DoradoPhoe extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_phoenix.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Phoenix", pais:"cali", imglist: [

    'assets/images/Dorado_phoenix.png',
  ], detalle:[
