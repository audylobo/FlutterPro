...
void doradopom() => runApp(DoradoPompom());
var currentCar = pezList.fishs[0];

class DoradoPompom extends StatelessWidget{
...
class DoradoPom extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_pompom.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Cometa", pais:"cali", imglist: [
    ...
    'assets/images/Dorado_pompom.png',
  ], detalle:[
