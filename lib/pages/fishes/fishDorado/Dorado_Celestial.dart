...
void doradocele() => runApp(DoradoCelestial());
var currentCar = pezList.fishs[0];

class DoradoCelestial extends StatelessWidget{
...
class DoradoCeles extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_celestial.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Abanico", pais:"cali", imglist: [

    'assets/images/Dorado_celestial.png',
  ], detalle:[
