...
void doradoaba() => runApp(DoradoAbanico());
var currentCar = pezList.fishs[0];

class DoradoAbanico extends StatelessWidget{
...
class DoradoAban extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_abanico.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Abanico", pais:"cali", imglist: [
    ...
    'assets/images/Dorado_abanico.png',
  ], detalle:[
