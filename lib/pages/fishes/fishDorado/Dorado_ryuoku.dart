...
void doradorio() => runApp(DoradoRyuoku());
var currentCar = pezList.fishs[0];

class DoradoRyuoku extends StatelessWidget{
...
class DoradoRyu extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_ryukin.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado Ryukin", nombrePez: "Ryukin", pais:"cali", imglist: [

    'assets/images/Dorado_ryukin.png',
  ], detalle:[
