...
void doradobel() => runApp(DoradoVelo());
var currentCar = pezList.fishs[0];

class DoradoVelo extends StatelessWidget{
...
class DoradoVel extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_velo.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado Velo", nombrePez: "Cometa", pais:"cali", imglist: [

    'assets/images/Dorado_velo.png',
  ], detalle:[
