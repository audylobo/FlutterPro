...
void doradoca() => runApp(DoradoCarpin());
var currentCar = pezList.fishs[0];

class DoradoCarpin extends StatelessWidget{
...
class DoradoCarpi extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Dorado_carpin.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Dorado", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Dorado_carpin.png',
  ], detalle:[
