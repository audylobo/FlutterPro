...
void mojalba() => runApp(MojarraAlbina());
var currentCar = pezList.fishs[0];

class MojarraAlbina extends StatelessWidget{
...
class MojarraAlbi extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Mojarra_albina.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Mojarra Albina", nombrePez: "OREOCHROMIS  SP", pais:"Africa", imglist: [

    'assets/images/Mojarra_albina.png',
  ], detalle:[

    {Icon(Icons.favorite, size: icoSize, color: Colors.pink):"EDAD MAX: 5 Años"},
    {Icon(FontAwesomeIcons.weightHanging, size: icoSize, color: Colors.blue):"Peso Max: 3000 gramos"},

  ],mediciones: [
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 45 cm"},
    {Icon(Icons.remove_circle_outline, size:icoSize, color: Colors.red):"Tamaño Minimo: 20 cm"},

  ],estiloDeVida: [
    {Icon(FontAwesomeIcons.temperatureHigh, size:icoSize, color:Colors.red):{"Temperatura maxima(upto)": "30 "}},
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"24"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.red):{"PH Maximo":"7"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.blue):{"PH Minimo":"5"}},

  ],descripcion: [
   {Icon(FontAwesomeIcons.indent, size: icoSize, color: Colors.pink):{"Descripcion": "se convirtió en la punta de lanza para el desarrollo acelerado de la piscicultura comercial a partir de la década de los 80 en países sin tradición acuícola en Sur América como: Mexico y Colombia"}}
  ]
  ),
]);
