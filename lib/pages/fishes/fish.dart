...
void fish() => runApp(Pez());
var currentCar = pezList.fishs[0];

class Pez extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Amarillo.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Pez Amarillo", nombrePez: "africano", pais:"cali", imglist: [

    'assets/images/2Amarillo.png', 'assets/images/Amarillo.png', 
  ], detalle:[
