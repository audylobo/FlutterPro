...
void tilaro() => runApp(TilapiaRosada());
var currentCar = pezList.fishs[0];

class TilapiaRosada extends StatelessWidget{
...
class TiRosa extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Tilapia_roja.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Tilapia comun", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Tilapia_roja.png',
  ], detalle:[
