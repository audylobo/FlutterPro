...
void tilanilo() => runApp(TilapiaNilo());
var currentCar = pezList.fishs[0];

class TilapiaNilo extends StatelessWidget{
...
class TiNilo extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Tilapia_nilo.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Tilapia Nilo", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Tilapia_nilo.png',
  ], detalle:[
