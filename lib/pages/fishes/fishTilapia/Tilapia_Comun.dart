...
void tilaco() => runApp(TilapiaComun());
var currentCar = pezList.fishs[0];

class TilapiaComun extends StatelessWidget{
...
class TiComun extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Tilapia.png', fit: BoxFit.fitWidth),
