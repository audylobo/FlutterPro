...
void tilazul() => runApp(TilapiaAzul());
var currentCar = pezList.fishs[0];

class TilapiaAzul extends StatelessWidget{
...
class TiAzul extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Tilapia_azul.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Tilapia Azul", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Tilapia_azul.png',
  ], detalle:[
