...
void corro() => runApp(Corroncho());
var currentCar = pezList.fishs[0];

class Corroncho extends StatelessWidget{
...
class Corron extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Corroncho.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Corroncho", nombrePez: "Chaetostoma", pais:"Sudamerica", imglist: [

    'assets/images/Corroncho.png',
  ], detalle:[

    {Icon(Icons.favorite, size: icoSize, color: Colors.pink):"EDAD MAX: 3 Años"},
    {Icon(FontAwesomeIcons.weightHanging, size: icoSize, color: Colors.blue):"Peso Max: 100 gramos"},
    ...
    {Icon(FontAwesomeIcons.temperatureHigh, size:icoSize, color:Colors.red):{"Temperatura maxima(upto)": "23 "}},
    ...
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.blue):{"PH Minimo":"3"}},

  ],descripcion: [
   {Icon(FontAwesomeIcons.indent, size: icoSize, color: Colors.pink):{"Descripcion": "Este es uno de los peces más apreciado por los acuarófilos, ya que este pez es un gran colaborador en la limpieza de los acuarios. Es del tipo de pez que vive perfectamente en cautiverio por tener un carácter tranquilo esto lo hace ser considerado como animal comunitario"}}
  ]
  ),
]);
