...
void saba() => runApp(Sabalo());
var currentCar = pezList.fishs[0];

class Sabalo extends StatelessWidget{
...
class Sabal extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Sabalo.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Sabalo", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Sabalo.png',
  ], detalle:[
