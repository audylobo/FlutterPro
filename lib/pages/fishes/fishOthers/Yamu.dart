...
class Yamu extends StatelessWidget{
...
class Yam extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Yamu.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Yamu", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Yamu.png',
  ], detalle:[
