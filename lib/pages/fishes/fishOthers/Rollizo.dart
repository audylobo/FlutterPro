...
void rolli() => runApp(Rollizo());
var currentCar = pezList.fishs[0];

class Rollizo extends StatelessWidget{
...
class Rolliz extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Rollizo.png', fit: BoxFit.fitWidth),
