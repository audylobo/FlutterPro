...
void piraro() => runApp(Pirarocu());
var currentCar = pezList.fishs[0];

class Pirarocu extends StatelessWidget{
...
class Pira extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Pirarocu.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Pirarocu", nombrePez: "Arapaima gigas", pais:"Colombia y Brazil", imglist: [

    'assets/images/Pirarocu.png',
  ], detalle:[

    {Icon(Icons.favorite, size: icoSize, color: Colors.pink):"EDAD MAX: 3 Años"},
    {Icon(FontAwesomeIcons.weightHanging, size: icoSize, color: Colors.blue):"Peso Max: 2500000 gramos"},

  ],mediciones: [
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 500 cm"},
    {Icon(Icons.remove_circle_outline, size:icoSize, color: Colors.red):"Tamaño Minimo: 300 cm"},

  ],estiloDeVida: [
    {Icon(FontAwesomeIcons.temperatureHigh, size:icoSize, color:Colors.red):{"Temperatura maxima(upto)": "28 "}},
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"26"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.red):{"PH Maximo":"6.5"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.blue):{"PH Minimo":"8.0"}},

  ],descripcion: [
   {Icon(FontAwesomeIcons.indent, size: icoSize, color: Colors.pink):{"Descripcion": "El pirarucu es uno de los peces de agua dulce más grandes del mundo y puede alcanzar hasta 3 metros de longitud"}}
  ]
  ),
]);
