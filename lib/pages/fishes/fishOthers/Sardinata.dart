...
void sardi() => runApp(Sardinata());
var currentCar = pezList.fishs[0];

class Sardinata extends StatelessWidget{
...
class Sardina extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Sardinata.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Sardinata", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Sardinata.png',
  ], detalle:[
