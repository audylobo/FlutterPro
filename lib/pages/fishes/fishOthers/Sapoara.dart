...
void sapo() => runApp(Sapoara());
var currentCar = pezList.fishs[0];

class Sapoara extends StatelessWidget{
...
class Sapoa extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Sapoara.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Sapoara", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Sapoara.png',
  ], detalle:[
