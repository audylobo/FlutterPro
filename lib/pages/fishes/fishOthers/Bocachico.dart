...
void boca() => runApp(Bocachico());
var currentCar = pezList.fishs[0];

class Bocachico extends StatelessWidget{
...
class Bocachi extends StatelessWidget{
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Bocachico", nombrePez: "Prochilodus magdalenae", pais:"colombia", imglist: [

    'assets/images/bobachico.png',
  ], detalle:[
    ...
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 50 cm"},
    ...
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"14"}},
