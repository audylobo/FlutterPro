...
void saba() => runApp(Sabaleta());
var currentCar = pezList.fishs[0];

class Sabaleta extends StatelessWidget{
...
class Sabale extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Sabaleta.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Sabaleta", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Sabaleta.png',
  ], detalle:[
