...
void lepo() => runApp(Leporino());
var currentCar = pezList.fishs[0];

class Leporino extends StatelessWidget{
...
class Lepori extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Leporino.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Leporino Lizado", nombrePez: "Leporinus fasciatus", pais:"cali", imglist: [

    'assets/images/Leporino.png',
  ], detalle:[
    ...
    {Icon(Icons.remove_circle_outline, size:icoSize, color: Colors.red):"Tamaño Minimo: 22 cm"},
    ...
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.blue):{"PH Minimo":"5.5"}},
