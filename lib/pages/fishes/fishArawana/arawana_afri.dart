...
void arawanaAfrican() => runApp(ArawanaAfricana());
var currentCar = pezList.fishs[0];

class ArawanaAfricana extends StatelessWidget{
...
class ArawanaAfrican extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Arawana_africana.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "arawana", nombrePez: "africana", pais:"cali", imglist: [

    'assets/images/Arawana_africana.png', 'assets/images/Arawana_africana.png', 
  ], detalle:[
