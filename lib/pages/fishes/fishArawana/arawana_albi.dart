...
void arawanaAlbi() => runApp(ArawanaAlbina());
var currentCar = pezList.fishs[0];

class ArawanaAlbina extends StatelessWidget{
...
class ArawanaAlbi extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Arrawana_Albina.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "arawana", nombrePez: "Albina", pais:"cali", imglist: [

    'assets/images/Arrawana_Albina.png', 'assets/images/Arawana_africana.png', 
  ], detalle:[
