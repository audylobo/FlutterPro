...
void arawanaAustri() => runApp(ArawanaAustraliana());
var currentCar = pezList.fishs[0];

class ArawanaAustraliana extends StatelessWidget{
...
class ArawanaAustri extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Arawana_australiana.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "arawana", nombrePez: "Australiana", pais:"cali", imglist: [

    'assets/images/Arawana_australiana.png', 'assets/images/Arawana_africana.png', 
  ], detalle:[

    {Icon(Icons.favorite, size: icoSize, color: Colors.pink):"EDAD MAX: 15 Años"},
    {Icon(FontAwesomeIcons.weightHanging, size: icoSize, color: Colors.blue):"Peso Max: 4600 gramos"},

  ],mediciones: [
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 120 cm"},
    {Icon(Icons.remove_circle_outline, size:icoSize, color: Colors.red):"Tamaño Minimo: 60 cm"},

  ],estiloDeVida: [
    {Icon(FontAwesomeIcons.temperatureHigh, size:icoSize, color:Colors.red):{"Temperatura maxima(upto)": "28 "}},
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"24"}},
   ...
   {Icon(FontAwesomeIcons.indent, size: icoSize, color: Colors.pink):{"Descripcion": "on omnívoros con una dieta natural que consiste principalmente en peces, e insectos tales como larvas. También comerán materia vegetal, pero esto es una pequeña parte de su dieta. Se sabe que comen casi cualquier cosa en la naturaleza que quepa en sus bocas, incluyendo aves, serpientes, monos, tortugas y roedores."}}
  ]
  ),
]);
