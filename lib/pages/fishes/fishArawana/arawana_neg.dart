...
void arawananegr() => runApp(ArawanaNegra());
var currentCar = pezList.fishs[0];

class ArawanaNegra extends StatelessWidget{
...
class Arawananegr extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Arawana_negra.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "arawana", nombrePez: "Negra", pais:"cali", imglist: [

    'assets/images/Arawana_negra.png', 
  ], detalle:[
