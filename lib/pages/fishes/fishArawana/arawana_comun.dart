...
void arawanacomu() => runApp(ArawanaComun());
var currentCar = pezList.fishs[0];

class ArawanaComun extends StatelessWidget{
...
class ArawanaCom extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Arawana_comun.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "arawana", nombrePez: "Comun", pais:"cali", imglist: [

    'assets/images/Arawana_comun.png', 'assets/images/Arawana_africana.png', 
  ], detalle:[
