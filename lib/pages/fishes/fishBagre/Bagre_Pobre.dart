...
void bagrepob() => runApp(BagrePobre());
var currentCar = pezList.fishs[0];

class BagrePobre extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Bagre_pobre.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Bagre", nombrePez: "Pobre", pais:"cali", imglist: [

    'assets/images/Bagre_pobre.png',
  ], detalle:[
