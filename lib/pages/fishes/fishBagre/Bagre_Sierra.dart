...
void bagresie() => runApp(BagreSierra());
var currentCar = pezList.fishs[0];

class BagreSierra extends StatelessWidget{
...
class Angie extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Bagre_sierra.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Bagre", nombrePez: "Sierra", pais:"cali", imglist: [

    'assets/images/Bagre_sierra.png',
  ], detalle:[
