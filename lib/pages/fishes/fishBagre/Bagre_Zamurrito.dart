...
void bagrezamu() => runApp(BagreZamurrito());
var currentCar = pezList.fishs[0];

class BagreZamurrito extends StatelessWidget{
...
class Daniela extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Bagre_zamurito.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Bagre", nombrePez: "Zamurrito", pais:"Mexico", imglist: [

    'assets/images/Bagre_zamurito.png',
  ], detalle:[
