...
void bagrecharru() => runApp(BagreCharruzco());
var currentCar = pezList.fishs[0];

class BagreCharruzco extends StatelessWidget{
...
class Janely extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Bagre_charruzco.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Bagre Charrazco", nombrePez: "Coridora Barbatus", pais:"Brazil", imglist: [

    'assets/images/Bagre_charruzco.png', 'assets/images/Bagre_charruzco.png', 
  ], detalle:[
    ...
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 13 cm"},
    {Icon(Icons.remove_circle_outline, size:icoSize, color: Colors.red):"Tamaño Minimo: 9 cm"},

  ],estiloDeVida: [
    {Icon(FontAwesomeIcons.temperatureHigh, size:icoSize, color:Colors.red):{"Temperatura maxima(upto)": "22 "}},
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"25"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.red):{"PH Maximo":"6.5"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.blue):{"PH Minimo":"7.5"}},

  ],descripcion: [
   {Icon(FontAwesomeIcons.indent, size: icoSize, color: Colors.pink):{"Descripcion": "Muchos tienen púas en sus aletas pectorales y dorsales, sea precavido. Conforman un grupo de 30 familias y más de 2.000 especies. Hay especies predadoras y otras más tímidas y herbívoras."}}
  ]
  ),
]);
