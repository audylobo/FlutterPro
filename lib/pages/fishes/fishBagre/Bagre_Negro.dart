...
void bagreneg() => runApp(BagreNegro());
var currentCar = pezList.fishs[0];

class BagreNegro extends StatelessWidget{
...
class Claider extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Bagre_negro.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Bagre", nombrePez: "Negro", pais:"cali", imglist: [

    'assets/images/Bagre_negro.png', 
  ], detalle:[
