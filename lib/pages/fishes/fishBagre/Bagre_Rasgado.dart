...
void bagreraya() => runApp(BagreRayado());
var currentCar = pezList.fishs[0];

class BagreRayado extends StatelessWidget{
...
class Estefanie extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Bagre_rayado.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Bagre", nombrePez: "Rayado", pais:"cali", imglist: [

    'assets/images/Bagre_rayado.png', 
  ], detalle:[
