...
void tucuco() => runApp(TucunapeComun());
var currentCar = pezList.fishs[0];

class TucunapeComun extends StatelessWidget{
...
class TucunaComun extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Tucunape.png', fit: BoxFit.fitWidth),
