...
void tucuazu() => runApp(TucunapeAzul());
var currentCar = pezList.fishs[0];

class TucunapeAzul extends StatelessWidget{
...
class TucuAzul extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Tucunape_azul.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Tucunape Comun", nombrePez: "Carpin", pais:"cali", imglist: [

    'assets/images/Tucunape_azul.png',
  ], detalle:[
