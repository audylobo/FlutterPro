...
void cachamacom() => runApp(Cachamacomun());
var currentCar = pezList.fishs[0];

class Cachamacomun extends StatelessWidget{
...
class CachamaCom extends StatelessWidget{
...
class _PezCarouselState extends State<PezCarousel>{
  ...
  final List<Widget> child = _map<Widget>(imgList,(index, String asstName){
    return Container(
      child: Image.asset(  'assets/images/Cachama_comun.png', fit: BoxFit.fitWidth),
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Cachama", nombrePez: "Comun", pais:"cali", imglist: [

    'assets/images/Cachama_comun.png', 
  ], detalle:[
