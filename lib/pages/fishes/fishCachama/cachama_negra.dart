...
void cachamane() => runApp(CachamaNegra());
var currentCar = pezList.fishs[0];

class CachamaNegra extends StatelessWidget{
...
class CachamaNegr extends StatelessWidget{
...
PezList pezList = PezList( fishs: [
  ...
  Peces1(nombreEspecie: "Cachama Negra", nombrePez: "Colossoma macropomum", pais:"Colombia", imglist: [

    'assets/images/Cachama_negra.png', 
  ], detalle:[

    {Icon(Icons.favorite, size: icoSize, color: Colors.pink):"EDAD MAX: 3 Años"},
    {Icon(FontAwesomeIcons.weightHanging, size: icoSize, color: Colors.blue):"Peso Max: 3500 gramos"},

  ],mediciones: [
    {Icon(Icons.control_point, size: icoSize, color: Colors.green):"Tamaño Maximo: 120 cm"},
    {Icon(Icons.remove_circle_outline, size:icoSize, color: Colors.red):"Tamaño Minimo: 70 cm"},

  ],estiloDeVida: [
    {Icon(FontAwesomeIcons.temperatureHigh, size:icoSize, color:Colors.red):{"Temperatura maxima(upto)": "15 "}},
    {Icon(FontAwesomeIcons.temperatureLow, size: icoSize, color: Colors.blue):{"temperatura minima(upto)" :"20"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.red):{"PH Maximo":"6.5"}},
    {Icon(FontAwesomeIcons.tencentWeibo, size: icoSize, color: Colors.blue):{"PH Minimo":"8.5"}},

  ],descripcion: [
   {Icon(FontAwesomeIcons.indent, size: icoSize, color: Colors.pink):{"Descripcion": "existen patrones definidos de coloración en el cuerpo, así en los ejemplares juveniles se presenta en el cuerpo manchas redondeadas u ovaladas, distinguiéndose las aletas pectorales y las pélvicas incoloras en ejemplares pequeños, las aletas pectorales, anal y pélvicas negras en juveniles mayores de 100 mm de largo estándar y muy oscuras o negras en adultos."}}
  ]
  ),
]);
